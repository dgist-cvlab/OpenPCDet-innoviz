...
from .box_util import generalized_box3d_iou
from .dist import all_reduce_average
from .misc import huber_loss
...
class SetCriterion(nn.Module):
    ...
    def loss_angle(self, outputs, targets, assignments):
        ...
        if targets["num_boxes_replica"] > 0:
            gt_angle_label = targets["gt_angle_class_label"].long()
    ...
    def forward(self, outputs, targets):
        ...
        targets['gt_box_sem_cls_label'] = targets['gt_box_sem_cls_label'].long()
