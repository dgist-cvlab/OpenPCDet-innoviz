...
from .pc_util import scale_points, shift_scale_points
from .box_util import flip_axis_to_camera_tensor, get_3d_box_batch_tensor, flip_axis_to_camera_np, get_3d_box_batch_np

from .helpers import GenericMLP
from .position_embedding import PositionEmbeddingCoordsSine
from ..backbones_trans.detr_modules.transformer import (MaskedTransformerEncoder, TransformerDecoder,
...
def build_encoder(args):
    if args.enc_type == "vanilla":
        ...
        encoder = TransformerEncoder(
            encoder_args=encoder_args, num_layers=args.enc_nlayers
        )
...
# 3DETR without Encoding part

class Model3DETREnc(nn.Module):
    """
    Main 3DETR model. Consists of the following learnable sub-models
    - pre_encoder: takes raw point cloud, subsamples it and projects into "D" dimensions
                Input is a Nx3 matrix of N point coordinates
