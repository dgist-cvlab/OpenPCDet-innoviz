...
class PointHeadSimpleYesz(PointHeadTemplate):
    """
    ...
    def assign_targets(self, input_dict):
        ...
        gt_boxes = input_dict['gt_boxes_yesz']
    ...
    def get_loss_with_mask(self, mask=None, tb_dict=None):
        tb_dict = {} if tb_dict is None else tb_dict
        point_loss_cls, tb_dict_1 = self.get_cls_layer_loss_with_mask(mask=mask)
    ...
    def forward(self, batch_dict):
        ...
        ret_dict = {
            ...
            'point_batch_ids': batch_dict['point_coords'][:,0],
        }
