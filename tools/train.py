...
def parse_config():
    ...
    parser.add_argument('--wandb', type=str, default='openpcdet2', help='wandb project name')
...
def main():
    from train_fold import parse_config as parse_config_fold
    args, cfg = parse_config()
    # args, cfg = parse_config_fold()
